...
class MainWindow(QMainWindow):
    ...
    def startProcesses(self):
        ...
        self._anim = libs.Animation_precise.Animation(self._animDataQ1, self._animDataQ2, self.signal, self._duration, self._readArraySize)
